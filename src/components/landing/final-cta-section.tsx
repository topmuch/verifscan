    ...
    <section className="py-24 relative overflow-hidden vs-hero-bg">
      ...
      >
        ...
        <div className="vs-popular-card p-10 sm:p-14 text-center">
          {/* Badge */}
          <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-[#DBEAFE] text-[#2563EB] text-xs font-semibold uppercase tracking-wide mb-6">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/register"
              className="vs-cta-pulse inline-flex items-center gap-2 h-14 px-8 rounded-xl bg-gradient-to-r from-[#2563EB] to-[#1D4ED8] text-white text-base font-semibold shadow-xl transition-all hover:scale-[1.02]"
            >
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 h-14 px-8 rounded-xl bg-white border-2 border-[#2563EB]/20 text-[#2563EB] hover:border-[#2563EB]/40 hover:bg-[#DBEAFE] text-base font-semibold transition-all hover:scale-[1.02]"
            >
          ...
          <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {benefits.map((b) => {
              ...
              return (
                ...
                >
                  <div className="size-10 rounded-xl bg-gradient-to-br from-[#10B981]/10 to-[#2563EB]/10 flex items-center justify-center">
          ...
          <div className="mt-10 pt-8 border-t border-[#E5E7EB] flex items-center justify-center gap-3 text-sm text-[#6B7280]">
            <div className="flex -space-x-2">
              {["🧑🏾", "👩🏾", "👨🏾‍💼", "👩🏾‍🦱", "🧑🏾‍🌾"].map((emoji, i) => (
                <div
                  key={i}
                  className="size-8 rounded-full bg-gradient-to-br from-[#DBEAFE] to-[#D1FAE5] border-2 border-white flex items-center justify-center text-sm shadow-sm"
                >
                  {emoji}
                </div>
              ))}
